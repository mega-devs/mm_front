...
import { Button, Line, MyLink, P, Title, TitleSmall } from '@/ui'
		...
		<div className={styles.pricing_choose}>
			...
			<div className={styles.pricing_choose__forever + ' style-block'}>
				...
				<div>
					...
					<MyLink to={ROUTE_NAMES.confirm}>
						<Button variant='outlined'>{t('pricingChoosePlanConfirm')}</Button>
					</MyLink>
				</div>
			</div>
			<Line />
